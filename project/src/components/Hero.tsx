        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="text-blue-300 block">Document Services</span>
            </h1>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl">
              Expert assistance with all your government document needs. From Aadhaar updates to passport applications, 
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <button
                ...
                className="bg-blue-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center space-x-2"
              >
            ...
            {/* Trust Indicators */}
            <div className="flex flex-wrap justify-center lg:justify-start gap-6 text-blue-100">
          ...
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-1">100% Secure Process</h3>
                  <p className="text-blue-100 text-sm">Your documents and personal information are completely safe with us</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-1">Fast Processing</h3>
                  <p className="text-blue-100 text-sm">Quick turnaround times with regular status updates</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm">Professional guidance through every step of the process</p>
                </div>
              </div>
            </div>
          </div>
